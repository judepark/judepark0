...
const NightstandPage = ({data}) => (
  <React.Fragment>
	<PageGrid2>
			...
			<HeaderDescription>
			A weekly “sit-down” podcast show, 
			Jude explores the works from books on his nightstand. 
			A little bit of stand-up, random thoughts, and philosophical questioning.
			Started from a radio show at <a href="http://www.trentradio.ca/" target="_blank">Trent Radio.</a>
			<br/>
			</HeaderDescription>	
			...
			<br/>
			<a href="https://soundcloud.com/judepark/theselfieofdoriangray">Soundcloud</a>
...
<img height="100%" src="nightstandposter.PNG"/>
...
<h5>
Episode 1 - "The Selfie of Dorian Gray"
</h5>

<iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/250930450&color=%23ffcc00&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>

<h5 style={{textAlign:"left"}}>
Jude explores what it means to age, to be beautiful, and what mortality means for him.

Classic works mentioned: The Picture of Dorian Gray by Oscar Wild. The Alchemist by Paulo Coelho. The Twits by Roald Dahl. Abs by Jude Park.
Music: Perahia and Lupu, Schubert - Fantasia. Glenn Gould, Bach - Concerto 3.
Originally aired: March 4th, 2016
</h5>
