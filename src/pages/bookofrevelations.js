...
const BookofRevelationsPage = ({data}) => (
  <React.Fragment>
	<PageGrid2>
			
			<HeaderTitle>
			<br/><br/><br/>
			<strong>Book of Revelations</strong>
			</HeaderTitle>
			...
			<HeaderDescription>
			10 short essays about random thoughts, 
			recollections of memories and conversations 
			had.
			<br/>
			</HeaderDescription>	
			...
			<br/>
			<a href="https://issuu.com/judepark/docs/bookofrevelations" target="_blank">Read Online</a>
...
<img height="100%" src="bofrcover.png"/>
...
<img width="950" src="bofrinside.png"/>


<img width="950" src="bofrbackcover.png"/>


<img width="950" src="bofrcoverandbook.png"/>
...
export default BookofRevelationsPage