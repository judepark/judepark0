...
const RobartsLibraryKiosksPage = ({data}) => (
  <React.Fragment>
	<PageGrid2>
			
			<HeaderTitle>
			<br/><br/><br/>
			<strong>Robarts Library Kiosks</strong>
			</HeaderTitle>
			...
			<HeaderDescription>
			<a href="https://onesearch.library.utoronto.ca/library-info/ROBARTS" target="_blank">Robarts Library,</a> the largest academic library at 
			the University of Toronto, came to us with a concern for 
			way-finding. To aid in their improvements for navigation, 
			we created an experience map to understand why the interactive 
			kiosks located across the library went unused.
			<br/>
			</HeaderDescription>	
...
<img width="580" src="robartslibrarykioskscover.png"/>
...
<img width="1000" src="robartslibrarykiosksphoto.png"/>
...
export default RobartsLibraryKiosksPage