...
const SupportingFacultyResponsetoStudentMentalHealthPage = ({data}) => (
  <React.Fragment>
	<PageGrid2>
			
			<HeaderTitle>
			<br/><br/><br/>
			<strong>Supporting Faculty Response to Student Mental Health</strong>
			</HeaderTitle>
			...
			<HeaderDescription>
			We were tasked to research how University of Toronto can 
			better support faculty response to student mental health concerns. 
			We designed a poser to highlight the insights and main concerns proposed 
			by our student participants. The poster won runner-up in the UX Research 
			Competition at University of Toronto in 2017.
			<br/>
			</HeaderDescription>	
...
<img height="100%" src="supportingfacultyresponsetostudentmentalhealthposter.png"/>
...
<img width="1000px" src="supportingfacultyresponsetostudentmentalhealthposter1.png"/>
...
export default SupportingFacultyResponsetoStudentMentalHealthPage