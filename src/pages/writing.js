...
const WritingPage = ({data}) => (
  <React.Fragment>
	  ...
	  <PageGrid>
		<HeaderTitle>
			<span style={{fontWeight: "800"}}>Writing</span>
		</HeaderTitle>
	...
	<div class="containerbook">
		<div class="book">
			<div class="front">
			<img src="https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1445790468l/24611786.jpg" alt="" width="108"></img>
			</div>
	...
	<div class="containerbook">
		<div class="book">
			<div class="front">
				<div class="cover">
					<p class="num-up">Jude Park</p>	
                    <p class="title">Healing from Family: The Abuses in Loving</p>
				</div>
			</div>
			<div class="left-side">
				<h2>
